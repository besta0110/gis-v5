(function($) {
    ...
    function setMcustomScrollBar($selector) {
        ...
        if((selector.length) && (windowWidth >= 320)) {
...
$('document').ready(function (){
  ...
  if ($("#toggle-btn2").hasClass("clicked")) {
    $("#toggle-btn2").removeClass("clicked");

    $(".fuse-chat").animate({ right: "0px" });
    $("#toggle-btn2").animate({ left: "-45px" });
  } else {
    $("#toggle-btn2").addClass("clicked");

    $(".fuse-chat").animate({ right: "70px" });
    $("#toggle-btn2").animate({ left: "-115px" });
  }
