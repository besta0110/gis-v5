  ...
  render() {
    ...
    return (
      <Container>
        ...
        {heroCount === 0 ? (<p>You have no any notification</p>) : (<Alert appearance="info"><p>You have {heroCount} pending item(s) waiting for your approval in <a href={this.ADMIN_PATH + '/heroes'}>Hero list</a></p></Alert>) }
      </Container>
    )
  }
}
